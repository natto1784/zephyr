...
enum ti_eqep_cap_clk_prescaler {
	TI_EQEP_CAP_CLK_DIV_1 = 0,   /* CAPCLK = EQEP_FICLK/1 */
	TI_EQEP_CAP_CLK_DIV_2 = 1,   /* CAPCLK = EQEP_FICLK/2 */
	TI_EQEP_CAP_CLK_DIV_4 = 2,   /* CAPCLK = EQEP_FICLK/4 */
	TI_EQEP_CAP_CLK_DIV_8 = 3,   /* CAPCLK = EQEP_FICLK/8 */
	TI_EQEP_CAP_CLK_DIV_16 = 4,  /* CAPCLK = EQEP_FICLK/16 */
	TI_EQEP_CAP_CLK_DIV_32 = 5,  /* CAPCLK = EQEP_FICLK/32 */
	TI_EQEP_CAP_CLK_DIV_64 = 6,  /* CAPCLK = EQEP_FICLK/64 */
	TI_EQEP_CAP_CLK_DIV_128 = 7, /* CAPCLK = EQEP_FICLK/128 */
};
...
enum ti_eqep_unit_pos_prescaler {
	TI_EQEP_UNIT_POS_DIV_1 = 0,     /* UPEVNT = QCLK/1 */
	TI_EQEP_UNIT_POS_DIV_2 = 1,     /* UPEVNT = QCLK/2 */
	TI_EQEP_UNIT_POS_DIV_4 = 2,     /* UPEVNT = QCLK/4 */
	TI_EQEP_UNIT_POS_DIV_8 = 3,     /* UPEVNT = QCLK/8 */
	TI_EQEP_UNIT_POS_DIV_16 = 4,    /* UPEVNT = QCLK/16 */
	TI_EQEP_UNIT_POS_DIV_32 = 5,    /* UPEVNT = QCLK/32 */
	TI_EQEP_UNIT_POS_DIV_64 = 6,    /* UPEVNT = QCLK/64 */
	TI_EQEP_UNIT_POS_DIV_128 = 7,   /* UPEVNT = QCLK/128 */
	TI_EQEP_UNIT_POS_DIV_256 = 8,   /* UPEVNT = QCLK/256 */
	TI_EQEP_UNIT_POS_DIV_512 = 9,   /* UPEVNT = QCLK/512 */
	TI_EQEP_UNIT_POS_DIV_1024 = 10, /* UPEVNT = QCLK/1024 */
	TI_EQEP_UNIT_POS_DIV_2048 = 11, /* UPEVNT = QCLK/2048 */
					/* 12-15 are reserved */
};
