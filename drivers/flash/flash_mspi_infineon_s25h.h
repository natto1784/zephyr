...
/* opcodes 1-1-1 mode */
#define INF_MSPI_S25H_OPCODE_READ_SFDP               0x5a
...
/* opcodes 4-4-4 mode */
#define INF_MSPI_S25H_OPCODE_READ_FLASH_QUAD_SDR 0xEB
#define INF_MSPI_S25H_OPCODE_READ_FLASH_QUAD_DDR 0xED
#define INF_MSPI_S25H_OPCODE_READ_JEDEC_ID_QUAD  0xAF

/* opcodes 8-8-8 mode */
#define INF_MSPI_S25H_OPCODE_READ_FLASH_OCTAL_SDR 0xEC
#define INF_MSPI_S25H_OPCODE_READ_FLASH_OCTAL_DDR 0xEE

/* RX delay cycles */
#define INF_MSPI_S25H_CYCLES_MEMLAT_SINGLE (8)
#define INF_MSPI_S25H_CYCLES_VRGLAT_SINGLE (0)
#define INF_MSPI_S25H_CYCLES_READ_SINGLE   (0)

/* 2 cycles for the mode bit to be ignored in Quad SPI mode; 8 from the default configuration */
#define INF_MSPI_S25H_CYCLES_MEMLAT_QUAD_SDR (2 + INF_MSPI_S25H_CYCLES_MEMLAT_SINGLE)
#define INF_MSPI_S25H_CYCLES_MEMLAT_QUAD_DDR (1 + INF_MSPI_S25H_CYCLES_MEMLAT_SINGLE)
#define INF_MSPI_S25H_CYCLES_VRGLAT_QUAD     (0)

#define INF_MSPI_S25H_CYCLES_MEMLAT_OCTAL   (20)
#define INF_MSPI_S25H_CYCLES_VRGLAT_OCTAL   (3)

/* addresses */
#define INF_MSPI_S25H_ADDRESS_VOLATILE_BASE 0x00800000
...
#define INF_MSPI_S25H_ADDRESS_VOLATILE_CFG_5 0x00800006
...
#define INF_MSPI_S25H_ADDRESS_NON_VOLATILE_CFG_5 0x6
...
#define INF_MSPI_S25H_DEFAULT_XFER_DATA                                                            \
	.async = false, .hold_ce = false, .priority = 0, .tx_dummy = 0,           \
	.xfer_mode = MSPI_PIO
...
#define INF_MSPI_S25H_CFG_5_OPI_IT_BIT BIT(0)
#define INF_MSPI_S25H_CFG_5_SDRDDR_BIT BIT(1)
